...
export interface components {
  schemas: {
    ...
    FolderServerNode: WithRequired<
      components['schemas']['ServerNode'],
      'id' | 'type'
    > & {
      /** Format: int64 */
      folderId: number;
      children: (
        | components['schemas']['FolderServerNode']
        | components['schemas']['PickServerNode']
      )[];
    };
    PickServerNode: WithRequired<
      components['schemas']['ServerNode'],
      'id' | 'type'
    > & {
      /** Format: int64 */
